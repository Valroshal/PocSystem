"""
Django settings for poc_systems_backend project.
...
SECRET_KEY = 'django-insecure-+y&2l!^-$dsw#0o$(hswgbvtdrx+dz9f27r*io&tj(3h3vvdoc'
...
WSGI_APPLICATION = 'poc_systems_backend.wsgi.application'
